...
<div class="btn-group">
    <button class="btn btn-{{ \Lyrasoft\Luna\Contact\ContactHelper::getStateColor($item->state) }} btn-sm dropdown-toggle" type="button" data-toggle="dropdown"
    ...
    <ul class="dropdown-menu">
        @foreach([0, 1, 2, -1] as $k)
            <li>
                <a class="" href="javascript:void(0);" onclick="Phoenix.Grid.doTask('{{ \Lyrasoft\Luna\Contact\ContactHelper::getStateSymbol($k) }}', {{ $i }});">
