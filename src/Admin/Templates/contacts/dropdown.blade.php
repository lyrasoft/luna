...
<div class="btn-group">
    <button
        class="btn btn-{{ \Lyrasoft\Luna\Contact\ContactHelper::getStateColor($item->state) }} btn-sm dropdown-toggle disable-on-submit"
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        @foreach([0, 1, 2, -1] as $k)
            <li class="">
                <a class="dropdown-item disable-on-submit" href="javascript:void(0);"
