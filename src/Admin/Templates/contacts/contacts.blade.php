 ...
 * @var $items         \Windwalker\Legacy\Data\DataSet|\Lyrasoft\Luna\Admin\Record\ContactRecord[]
...
@section('admin-body')
    <div id="phoenix-admin" class="contacts-container grid-container">
        <form name="admin-form" id="admin-form" action="{{ $router->route('contacts') }}" method="POST"
                    ...
                    @foreach ($items as $i => $item)
                        ...
                        <tr data-order-group="">
                            ...
                            @if ($entity->hasField('subject'))
                                {{-- SUBJECT --}}
                                <td>
                                    <a href="{{ $router->route('contact', ['id' => $item->id]) }}"
                            ...
                            <td>
                                @if ($item->user_name)
                                    <a class="text-muted" href="{{ $router->to('user', ['id' => $item->user_id]) }}"
                                       target="_blank">
                                        {{ $item->user_name }}
