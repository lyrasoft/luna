...
@section('admin-body')
    <div id="phoenix-admin" class="comments-container grid-container">
        <form name="admin-form" id="admin-form" action="{{ $router->route('comments', array('type' => $type)) }}"
                        ...
                        <tr data-order-group="{{ $item->type }}-{{ $item->target_id }}">
                            ...
                            <td>
                                <a class="btn btn-default btn-sm"
                                   href="{{ $router->route('comment', array('id' => $item->id, 'type' => $type)) }}">
                            ...
                            <td class="hasHighlight">
                                @if (\Lyrasoft\Warder\Helper\WarderHelper::tableExists('users'))
                                    ...
                                    <br/>
                                @endif
                                {!! \Windwalker\Legacy\String\Utf8String::substr(e($item->content), 0, 150) !!}...
                            </td>
                            ...
                            <td class="hasHighlight">
                                @if ($item->reply)
                                    @if (\Lyrasoft\Warder\Helper\WarderHelper::tableExists('users'))
                                        ...
                                        <br/>
                                    @endif
                                    {!! \Windwalker\Legacy\String\Utf8String::substr(e($item->reply), 0, 150) !!}...
                                @endif
                            </td>
