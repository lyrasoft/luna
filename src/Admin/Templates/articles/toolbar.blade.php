 ...
 * @var $helper   \Lyrasoft\Merlin\Admin\Helper\MenuHelper        The Windwalker HelperSet object.
 * @var $router   \Windwalker\Core\Router\PackageRouter  Router object.
 */
?>

<a type="button" class="btn btn-success btn-sm" href="{{ $router->html('article', array('new' => true)) }}">
