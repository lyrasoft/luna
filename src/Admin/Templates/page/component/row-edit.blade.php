...
<row-edit inline-template ref="rowEdit">
    <div>
                        ...
                        <div class="tab-content" id="row-edit-tab-content">
                            ...
                            <div class="tab-pane fade show active" id="row-edit-general" role="tabpanel" aria-labelledby="row-edit-general-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input-row-edit-title-text" type="text"
                                        v-model="options.title.text" class="form-control" />
                                    <small class="form-text text-muted">這個 Section 的大標題，不需要的話保持空白即可</small>
                                </div>

                                <div v-if="options.title.text !== ''">
                                    <div class="form-row">
                                        <div class="col-6">
                                            {{-- Title Element --}}
                                            <div class="form-group">
                                                <label for="input-row-edit-title-element">
                                                    標題元素
                                                </label>
                                                <select id="input-row-edit-title-element"
                                        ...
                                        <div class="col-6">
                                            {{-- Title Color --}}
                                            <div class="form-group">
                                                <label for="input-row-edit-title-color">標題顏色</label>
                                                <input id="input-row-edit-title-color" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="input-row-edit-subtitle-text" type="text"
                                        v-model="options.subtitle.text" class="form-control" />
                                ...
                                <transition name="fade">
                                    <div v-if="['image'].indexOf(options.background.type) !== -1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="input-row-edit-bg-image" type="text"
