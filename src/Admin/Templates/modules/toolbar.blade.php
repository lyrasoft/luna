...
<a role="button" href="javascript://" class="btn btn-primary btn-sm phoenix-btn-new" data-toggle="modal"
   data-target="#module-create-modal">
...
<button type="button" class="btn btn-success btn-sm phoenix-btn-publish"
...
<button type="button" class="btn btn-default btn-outline-secondary btn-sm phoenix-btn-batch" data-toggle="modal"
