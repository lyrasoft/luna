...
use Lyrasoft\Luna\Admin\Repository\MenusRepository;
use Lyrasoft\Luna\Admin\View\Menus\MenusHtmlView;
...
class GetController extends ListDisplayController
{
     ...
     * @var  string
     */
    protected $defaultOrdering = 'menu.lft';
