	...
	public function define(Form $form)
	{
		...
		$form->wrap(null, 'search', function (Form $form)
		{
			...
			$form->add('field', new ListField)
				...
				->addOption(new Option(Translator::translate('admin.tag.field.title'), 'tag.title'))
				->addOption(new Option(Translator::translate('admin.tag.field.alias'), 'tag.alias'));
		...
		$form->wrap(null, 'filter', function(Form $form)
		{
			...
			$form->add('tag.state', new ListField)
				...
				->addOption(new Option(Translator::translate('admin.tag.filter.state.select'), ''))
