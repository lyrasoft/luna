...
import ButtonRadio from './form/ButtonRadio.vue';
import ColorInput from './form/ColorInput.vue';
import SingleImage from "./form/SingleImage.vue";
import Gradient from "./form/Gradient.vue";
...
async function savePage() {
  u.trigger<ColumnSaveEvent>('column:save', JSON.parse(JSON.stringify(content.value)));
...
<template>
  <div>
    <BsModal :open="modalShow" size="lg" @hidden="modalShow = false"
      ...
      <div v-if="content && options" class="tab-content" id="column-edit-tab-content">
        <!-- Tab General -->
        <div class="tab-pane fade show active" id="column-edit-general" role="tabpanel" aria-labelledby="column-edit-general-tab">
          ...
          <div v-if="options.border.enabled == 1">
            ...
            <RwdGroup class-name="c-border-width">
              ...
              <template v-for="size of ['lg', 'md', 'xs']" class="form-group mb-3"
                ...
                <SliderInput
                  v-model="options.border.width[size as 'lg' | 'md' | 'xs']"
                />
              </template>
            </RwdGroup>
          ...
          <RwdGroup class-name="c-border-radius">
            ...
            <template v-for="size of ['lg', 'md', 'xs']" class="form-group mb-3"
              ...
              <SliderInput
                v-model="options.border.radius[size as 'lg' | 'md' | 'xs']"
                :max="500"
              />
            </template>
          </RwdGroup>
